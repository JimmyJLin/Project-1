  ...
  function Game(){
    ...
    function switchPlayer(){
      if (dogOne.turn === true){
        ...
        diceMsg(dogOne + " Rolled" + diceRoll);
        ...
        checkWinner()
        return;
      } else if (dogTwo.turn === false) {
        console.log("DogTwo Turn")
        var diceRoll = diceRoll();
        diceMsg(dogTwo + " Rolled" + diceRoll);
        dogTwo.currentStep += this.diceRoll;
        dogTwo.move = this.currentStep.toString();
        movingXandY();
        dogTwo.moveCount++;
        dogTwo.turn = true;
        boardMsg("")
